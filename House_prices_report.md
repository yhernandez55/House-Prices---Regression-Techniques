...
Boxplot:
![alt text](image-target_boxplot.png) 

Histogram:
![alt text](image-target_hist.png)
...
![alt text](image-heapmap_important.png)
...
![alt text](image-top10_corr_ft.png)
...
![alt text](image-OverallQual_Distribution.png)

Boxplot of SalePrice by OverallQual:
![alt text](image-OveallQual_Boxplot.png)
...
![alt text](image-FullBath_countplot.png)

Boxplot of SalePrice by FullBath:
![alt text](image-FullBath_Boxplot.png)

Count plot for HalfBath variable:
![alt text](image-HalfBath_countplot.png)

Boxplot of SalePrice by HalfBath:
![alt text](image-HalfBath_Boxplot.png)
...
![alt text](image-TotRmsAbvGrd_countplot.png)
